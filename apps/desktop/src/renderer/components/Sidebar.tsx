interface SidebarProps {
  isOpen: boolean;
  view: 'search' | 'saved' | 'resume' | 'settings';
  onViewChange: (view: 'search' | 'saved' | 'resume' | 'settings') => void;
  onClose: () => void;
  weeklyRemaining: number | null;
  monthlyRemaining: number | null;
}

const navItems: { id: 'search' | 'saved' | 'resume' | 'settings'; label: string; icon: string }[] =
  [
    {
      id: 'search',
      label: 'Search',
